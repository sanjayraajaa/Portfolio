...
const homeData = {
  ...
  resumeLink: "", // Keep empty to simulate unavailable file
  description: [
...
const handleResumeDownload = () => {
  if (!homeData.resumeLink) {
    toast.warning("📢 Content not available. We are updating soon!", {
    ...
    window.location.href = homeData.resumeLink;
  }
};
